...
contract BaseERC1155 is IERC1155, Context, IERC1155MetadataURI, ERC165, EIP712 {
 ...
 function permit(
        ...
        if (block.timestamp > deadline) revert("invalid signature");
    ...
    constructor() EIP712("AKX.ID.GLOBAL", "1") {
        _owner = msg.sender;
    }
    ...
    modifier onlyOwner() {
        require(_owner == _msgSender(), "only owner is allowed");
        _;
    }
    ...
    function tokenURI(bytes32 ID) public view returns (string memory) {
        ...
        return string.concat(baseMetadataUri, idStr);
    }
        ...
        returns (uint256)
    {
        ...
        return 1; // will always be 1 AKX ID per address
    }
